...
var turnOrder = require('./turn-order-9375b0ef.js');
var redux = require('redux');
var reducer = require('./reducer-3779d6a8.js');
var Debug = require('./Debug-57c7a8eb.js');
...
function () {
  function _ClientImpl(_ref) {
    ...
    turnOrder._classCallCheck(this, _ClientImpl);
    ...
    this.reset = function () {
      _this.store.dispatch(turnOrder.reset(_this.initialState));
    };

    this.undo = function () {
      _this.store.dispatch(turnOrder.undo(playerID, credentials));
    };

    this.redo = function () {
      _this.store.dispatch(turnOrder.redo(playerID, credentials));
    };
            ...
            case turnOrder.GAME_EVENT:
              {
                ...
                _this.log = [].concat(turnOrder._toConsumableArray(_this.log), turnOrder._toConsumableArray(deltalog));
                break;
              }
            ...
            case turnOrder.UPDATE:
              {
                ...
                _this.log = [].concat(turnOrder._toConsumableArray(_this.log), turnOrder._toConsumableArray(_deltalog));
                break;
              }
  ...
  turnOrder._createClass(_ClientImpl, [{
    ...
    value: function getState() {
      ...
      var ret = turnOrder._objectSpread2({}, state, {
        isActive: isActive,
        G: G,
        log: this.log
      });
      ...
      ret = turnOrder._objectSpread2({}, ret, {
