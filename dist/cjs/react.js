...
require('./Debug-57c7a8eb.js');
require('flatted');
var ai = require('./ai-68b0f661.js');
require('./initialize-752804a6.js');
var client = require('./client-0c81a68d.js');
var React = _interopDefault(require('react'));
var PropTypes = _interopDefault(require('prop-types'));
var Cookies = _interopDefault(require('react-cookies'));
require('./base-bdd9c13b.js');
var socketio = require('./socketio-869623e8.js');
require('./master-db89c6a1.js');
  ...
  function (_React$Component) {
    ...
    turnOrder._createClass(WrappedBoard, [{
      ...
      value: function render() {
        ...
        if (board) {
          _board = React.createElement(board, turnOrder._objectSpread2({}, state, {}, this.props, {
